...
public class EndToEndAppTest {
  ...
  @Tag("File")
  @Test
  void testApp_OnExampleJavaFileWithComments_CommentsDontHaveLeadingSpace_ShouldWork()
  ...
  void testApp_OnExampleFile_ThatDoesntHaveAClass_ShouldWork() throws CmdLineException {
    // Note: Partial Java Classes are ok? i.E. the File does not have a class around it, just a
    // method.
  ...
  void testApp_missingPathWidth_shouldError() {
    String testFilePath = "src/test/resources/jsonTest.jsonl";
    String[] args = {
      "--file", testFilePath, "--max_path_length", "200",
    };
  ...
  @Tag("File")
  @Test
  void testApp_OnExampleFile_MissingBracket_ShouldWork() throws CmdLineException {
    // Note: in method FeatureExtractor.parseFilesWithRetries() added a case where a single
    // bracket is included.
    String testFilePath = "src/test/resources/examples/bracket.java";
    String[] args = {"--file", testFilePath, "--max_path_length", "200", "--max_path_width", "10"};
